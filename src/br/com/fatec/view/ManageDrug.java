...
public class ManageDrug extends javax.swing.JFrame {
    Drug drug;
     ...
     */
    public ManageDrug() throws ParseException {
        initComponents();
        TableFill();
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(890, 730));
    ...
    private void tbDrugMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbDrugMouseClicked
        ...
        try {
            ...
            Logger.getLogger(ManageDrug.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ManageDrug.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManageDrug.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
